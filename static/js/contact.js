...
$(document).ready(function()
{
	...
	*/
	function initGoogleMap() {
		var myLatlng = new google.maps.LatLng(23.8103, 90.4125); // Coordinates for Dhaka, Bangladesh
		var mapOptions = {
			center: myLatlng,
			zoom: 14,
		...
		// Add a marker for Bangladesh (Dhaka)
		var marker = new google.maps.Marker({
			position: myLatlng, // Reuse the myLatlng variable for Dhaka
			map: map,
